...
const Faq: React.FC = () => (
  <div className="max-w-2xl mx-auto px-4 py-10 text-blue-900">
    ...
    <p className="mb-6">Encontre aqui as respostas para as dúvidas mais frequentes sobre nossa loja e nossos produtos. Nossa missão é tornar a sua experiência de compra a mais transparente e agradável possível.</p>
