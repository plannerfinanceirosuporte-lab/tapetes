...
import { updateUtmifyOrderStatus, CustomerData, UtmifyProduct } from '../../lib/utmify';
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      ...
      const customer: CustomerData = {
        ...
        document: selectedOrder.customer_document || ''
      };
      ...
      const totalAmountInCents = Math.round(Number(selectedOrder.total_amount) * 100);
      ...
      await updateUtmifyOrderStatus(
        ...
        products,
        totalAmountInCents,
        selectedOrder.payment_method as 'PIX' | 'CREDIT_CARD' | 'BILLET'
      );
      ...
      console.error('Erro ao atualizar status do pedido na UTMify:', err);
            ...
            <div className="space-y-6">
              ...
              <div className="border-t pt-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-blue-600">R$ {Number(selectedOrder.total_amount).toFixed(2).replace('.', ',')}</span>
                </div>
              </div>
            </div>
          </div>
